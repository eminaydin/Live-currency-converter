...
export const ERROR_MESSAGES = {
    noAmount: "The deal was you gonna give me a number and I will convert it right?",
    amountZero: "As far as I know, 0 times something is always 0.",
    equalCurrency: "Calculation of equal currencies would result in equal outcomes",
...
export const formattedAmount = (amount) => new Intl.NumberFormat('de-DE').format(amount)