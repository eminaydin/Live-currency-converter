    ...
    <div className="history-page">
      ...
      <div className="conversion-history-table">
        <table>
          ...
          {calculationHistory.map(
            ({ amount, currencyTo, currencyFrom, multipliedAmount, date }) => {
              return (
                <tr key={date}>
                  <td>
                  ...
                  <td>
                    {formattedAmount(amount)} {currencyFrom}
                  </td>
                  <td>
                    {formattedAmount(multipliedAmount)} {currencyTo}
                  </td>
                </tr>
              );
            }
